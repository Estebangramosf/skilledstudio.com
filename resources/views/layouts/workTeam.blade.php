<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Director General'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Co-Fundador'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Director de Música'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Director de Guión'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Productor Musical'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Compositor'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Orquestador y Compositor'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Director de Programación'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Programador'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Director de diseño de niveles'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Director de Diseño'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Director de Ilustración'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Ilustrador y VFX'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Ilustrador'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Directora de Marketing'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Dirección de Animación 3D'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Animacion 3D'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Animación 3D'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Director de Modelado 3D'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Modelador 3D'))}}
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="thumbnail" style="background: transparent;background-color: transparent;border: transparent;">
              <a href="#!">
                ...
                <div align="middle" class="caption" style="color:#FFF;/*text-shadow: 0px 0px 8px rgb(255, 255, 255);*/">
                  ...
                  <hr>
                  <p>
                    {{utf8_decode(utf8_encode('Traductora'))}}
                  </p>
                </div>
              </a>
            </div>
  ...
  <a class="left carousel-control" href="#carousel-example-generic" role="button" data-slide="prev">
    <div align="middle">Anterior</div>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
    <div align="middle">Siguiente</div>
